...
<body>
    <div class="container">
        ...
        <form name="formulario" action="../../controllers/produto/inserir_produto.php" method="post">
            <label for="produto">Nome do produto</label>
            <input type="text" name="produto" class="form-control" autocomplete="off" required>
            
            <label for="preco">Preço</label>
            <input type="text" name="preco" class="form-control" autocomplete="off" required>
